pipeline {
    ...
    stages {
     ...
     post{
        always{
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: false, reportDir: 'cypress/reporter', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: 'Last report'])
        }
     }
}
